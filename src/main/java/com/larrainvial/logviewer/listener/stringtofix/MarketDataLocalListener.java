    ...
    public synchronized void eventOccurred(Event event) {
        ...
        try {
            ...
            if (validateMessage(message)) {
                ...
                Controller.dispatchEvent(new SendMessageMKDLocalEvent(this, algo, businessMessageReject));

            } else {

                message.setString(SecondaryOrderID.FIELD, ev.algo.nameAlgo);
                message.setString(SecondaryExecID.FIELD, Constants.TypeMarket.MKD_LOCAL);

                Controller.dispatchEvent(new SendMessageMKDLocalEvent(this, algo, message));
