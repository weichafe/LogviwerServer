...
public class SendPositionEvent  extends Event {
    ...
    public SendPositionEvent(Object source, String nameAlgo, String typeMarket, ModelRoutingData modelRoutingData) {
        super(source);
